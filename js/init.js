...
$(document).ready(function () {
    ...
    $("#year1").click(function () {
        $("#showhide1").animate({width:'toggle'},"slow");
        $("#showhide2").hide();
        $("#showhide3").hide();
        $("#showhide4").hide();
    });
    $("#year2").click(function () {
        $("#showhide2").animate({width:'toggle'},"slow");
        $("#showhide1").hide();
        $("#showhide3").hide();
        $("#showhide4").hide();
    });
    $("#year3").click(function () {
        $("#showhide3").animate({width:'toggle'},"slow");
        $("#showhide1").hide();
        $("#showhide2").hide();
        $("#showhide4").hide();
    });
    $("#year4").click(function () {
        $("#showhide4").animate({width:'toggle'},"slow");
        $("#showhide1").hide();
        $("#showhide2").hide();
        $("#showhide3").hide();
    });
    ...
    $(".fa-code").click(function () {
        /* Show the relevant info according to the function. Also provide links if possible*/
        $("#code").animate({width:'toggle'},"slow");
        $(".fa-magic").fadeToggle();
        $(".fa-bolt").fadeToggle();
        $(".fa-bullhorn").fadeToggle();

    });
    $(".fa-magic").click(function () {
        /* Show the relevant info according to the function. Also provide links if possible*/
        $("#create").animate({width:'toggle'},"slow");
        $(".fa-code").fadeToggle();
        $(".fa-bolt").fadeToggle();
        $(".fa-bullhorn").fadeToggle();
    ...
    $(".fa-bolt").click(function () {
        /* Show the relevant info according to the function. Also provide links if possible*/
        $("#ideate").animate({width:'toggle'},"slow");
        $(".fa-magic").fadeToggle();
        $(".fa-code").fadeToggle();
        $(".fa-bullhorn").fadeToggle();
    ...
    $(".fa-bullhorn").click(function () {
        /* Show the relevant info according to the function. Also provide links if possible*/
        $("#speak").animate({width:'toggle'},"slow");
        $(".fa-magic").fadeToggle();
        $(".fa-bolt").fadeToggle();
        $(".fa-code").fadeToggle();
